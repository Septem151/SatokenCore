...
/**
 * Class containing various hashing algorithms and functions, as well as signing
 * algorithms.
 *
...
public class Hash {
    ...
    /**
     * Signs data with ECDSA and returns the signature.
     *
     * @param data the data to sign.
     * @param privateKey the key used to sign the data.
    ...
    /**
     * Verifies signed data with a given signature and public key.
     *
     * @param data the data to verify.
     * @param sig the signature to verify data with.
     * @param publicKey the public key used to verify.
     * @return whether the given signature and public key are valid.
     */
     ...
     * @return the RIPEMD-160 hash of the data.
     */
    public static byte[] ripemd160(byte[] data) {
        return Ripemd160.getHash(data);
    }

    /**
     * @param data the data to hash.
     * @return the RIPEMD-160 hash of the SHA-256 hash of the data.
     */
    ...
    /**
     * Internal class that adds ability to calculate RIPEMD-160 hash.
     */
